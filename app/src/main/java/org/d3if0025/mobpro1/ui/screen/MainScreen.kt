...
import org.d3if0025.mobpro1.navigation.Screen
import org.d3if0025.mobpro1.ui.theme.MobPro1Theme
import org.d3if0025.mobpro1.util.SettingsDataStore
...
fun ScreenContent(showList: Boolean, modifier: Modifier, navController: NavHostController) {
    ...
    if (data.isEmpty()) {
        Column(
            ...
            Image(painterResource(R.drawable.snowwash), contentDescription = null)
...
@Composable
fun ListItem(cuci: Cuci, onClick: (Cuci) -> Unit) {
    val context = LocalContext.current

    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick(cuci) }
            .padding(16.dp),
...
@Composable
fun GridItem(cuci: Cuci, onClick: () -> Unit) {
    val context = LocalContext.current
